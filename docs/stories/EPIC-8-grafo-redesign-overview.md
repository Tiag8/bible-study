...
> **Status**: Em progresso (3/7 concluidos)
> **Data**: 2026-01-31
...
| **8.4** | Legenda e Controles Redesenhados | P0 | 8.2 concluido | [EPIC-8.4](EPIC-8.4-legenda-controles.md) | Proximo |
| **8.5** | UI de Gestao de Links | P1 | 8.2 concluido | [EPIC-8.5](EPIC-8.5-gestao-links.md) | Pendente |
...
| Touch targets >= 44px | 0% | 100% | Pendente (EPIC 8.7) |
