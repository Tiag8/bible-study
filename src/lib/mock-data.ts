...
export const mockBibleBooks: BibleBook[] = [
  ...
  { id: "gen", name: "Gênesis", testament: "AT", totalChapters: 50, studiedChapters: [1, 3], tags: ["Criação", "Fé"], lastUpdate: "2024-01-18T09:30:00Z" },
  { id: "exo", name: "Êxodo", testament: "AT", totalChapters: 40, studiedChapters: [20], tags: ["Lei"], lastUpdate: "2024-01-10T14:00:00Z" },
  { id: "lev", name: "Levítico", testament: "AT", totalChapters: 27, studiedChapters: [], tags: ["Lei"], lastUpdate: null },
  { id: "num", name: "Números", testament: "AT", totalChapters: 36, studiedChapters: [], tags: [], lastUpdate: null },
  { id: "deu", name: "Deuteronômio", testament: "AT", totalChapters: 34, studiedChapters: [], tags: ["Lei"], lastUpdate: null },
  { id: "jos", name: "Josué", testament: "AT", totalChapters: 24, studiedChapters: [1], tags: ["Fé"], lastUpdate: "2024-01-05T10:00:00Z" },
  { id: "jdg", name: "Juízes", testament: "AT", totalChapters: 21, studiedChapters: [], tags: [], lastUpdate: null },
  { id: "rut", name: "Rute", testament: "AT", totalChapters: 4, studiedChapters: [1, 2, 3, 4], tags: ["Amor", "Fé"], lastUpdate: "2024-01-20T08:00:00Z" },
  ...
  { id: "job", name: "Jó", testament: "AT", totalChapters: 42, studiedChapters: [1, 42], tags: ["Sabedoria", "Fé"], lastUpdate: "2024-01-12T16:00:00Z" },
  { id: "psa", name: "Salmos", testament: "AT", totalChapters: 150, studiedChapters: [1, 23, 91, 119], tags: ["Sabedoria", "Fé"], lastUpdate: "2024-01-16T11:30:00Z" },
  { id: "pro", name: "Provérbios", testament: "AT", totalChapters: 31, studiedChapters: [1, 3, 16], tags: ["Sabedoria", "Princípios"], lastUpdate: "2024-01-15T12:00:00Z" },
  { id: "ecc", name: "Eclesiastes", testament: "AT", totalChapters: 12, studiedChapters: [], tags: ["Sabedoria"], lastUpdate: null },
  { id: "sng", name: "Cantares", testament: "AT", totalChapters: 8, studiedChapters: [], tags: ["Amor"], lastUpdate: null },
  { id: "isa", name: "Isaías", testament: "AT", totalChapters: 66, studiedChapters: [53], tags: ["Profecia", "Salvação"], lastUpdate: "2024-01-08T09:00:00Z" },
  { id: "jer", name: "Jeremias", testament: "AT", totalChapters: 52, studiedChapters: [], tags: ["Profecia"], lastUpdate: null },
  { id: "lam", name: "Lamentações", testament: "AT", totalChapters: 5, studiedChapters: [], tags: [], lastUpdate: null },
  { id: "ezk", name: "Ezequiel", testament: "AT", totalChapters: 48, studiedChapters: [], tags: ["Profecia"], lastUpdate: null },
  { id: "dan", name: "Daniel", testament: "AT", totalChapters: 12, studiedChapters: [3, 6], tags: ["Profecia", "Fé"], lastUpdate: "2024-01-14T15:00:00Z" },
  { id: "hos", name: "Oséias", testament: "AT", totalChapters: 14, studiedChapters: [], tags: ["Amor"], lastUpdate: null },
  { id: "joe", name: "Joel", testament: "AT", totalChapters: 3, studiedChapters: [], tags: ["Profecia"], lastUpdate: null },
  ...
  { id: "jon", name: "Jonas", testament: "AT", totalChapters: 4, studiedChapters: [1, 2], tags: ["Graça"], lastUpdate: "2024-01-03T10:00:00Z" },
  { id: "mic", name: "Miquéias", testament: "AT", totalChapters: 7, studiedChapters: [], tags: ["Profecia"], lastUpdate: null },
  { id: "nah", name: "Naum", testament: "AT", totalChapters: 3, studiedChapters: [], tags: [], lastUpdate: null },
  { id: "hab", name: "Habacuque", testament: "AT", totalChapters: 3, studiedChapters: [], tags: ["Fé"], lastUpdate: null },
  ...
  { id: "zec", name: "Zacarias", testament: "AT", totalChapters: 14, studiedChapters: [], tags: ["Profecia"], lastUpdate: null },
  { id: "mal", name: "Malaquias", testament: "AT", totalChapters: 4, studiedChapters: [], tags: [], lastUpdate: null },

  // NOVO TESTAMENTO (27 livros)
  { id: "mat", name: "Mateus", testament: "NT", totalChapters: 28, studiedChapters: [5, 6, 7], tags: ["Salvação", "Lei"], lastUpdate: "2024-01-19T14:00:00Z" },
  { id: "mrk", name: "Marcos", testament: "NT", totalChapters: 16, studiedChapters: [], tags: [], lastUpdate: null },
  { id: "luk", name: "Lucas", testament: "NT", totalChapters: 24, studiedChapters: [15], tags: ["Graça", "Amor"], lastUpdate: "2024-01-11T13:00:00Z" },
  { id: "jhn", name: "João", testament: "NT", totalChapters: 21, studiedChapters: [1, 3, 14, 15], tags: ["Amor", "Salvação"], lastUpdate: "2024-01-19T11:00:00Z" },
  { id: "act", name: "Atos", testament: "NT", totalChapters: 28, studiedChapters: [2], tags: ["Fé"], lastUpdate: "2024-01-06T09:00:00Z" },
  { id: "rom", name: "Romanos", testament: "NT", totalChapters: 16, studiedChapters: [1, 3, 5, 8, 12], tags: ["Salvação", "Graça", "Fé"], lastUpdate: "2024-01-17T16:00:00Z" },
  { id: "1co", name: "1 Coríntios", testament: "NT", totalChapters: 16, studiedChapters: [13], tags: ["Amor"], lastUpdate: "2024-01-09T10:00:00Z" },
  { id: "2co", name: "2 Coríntios", testament: "NT", totalChapters: 13, studiedChapters: [], tags: [], lastUpdate: null },
  { id: "gal", name: "Gálatas", testament: "NT", totalChapters: 6, studiedChapters: [5], tags: ["Graça", "Fé"], lastUpdate: "2024-01-13T11:00:00Z" },
  { id: "eph", name: "Efésios", testament: "NT", totalChapters: 6, studiedChapters: [2, 6], tags: ["Graça", "Fé"], lastUpdate: "2024-01-18T15:00:00Z" },
  { id: "php", name: "Filipenses", testament: "NT", totalChapters: 4, studiedChapters: [4], tags: ["Fé"], lastUpdate: "2024-01-07T08:00:00Z" },
  ...
  { id: "2ti", name: "2 Timóteo", testament: "NT", totalChapters: 4, studiedChapters: [], tags: ["Fé"], lastUpdate: null },
  ...
  { id: "heb", name: "Hebreus", testament: "NT", totalChapters: 13, studiedChapters: [11], tags: ["Fé"], lastUpdate: "2024-01-04T14:00:00Z" },
  { id: "jas", name: "Tiago", testament: "NT", totalChapters: 5, studiedChapters: [1, 2], tags: ["Fé", "Sabedoria"], lastUpdate: "2024-01-15T09:00:00Z" },
  ...
  { id: "1jn", name: "1 João", testament: "NT", totalChapters: 5, studiedChapters: [4], tags: ["Amor"], lastUpdate: "2024-01-02T10:00:00Z" },
  ...
  { id: "rev", name: "Apocalipse", testament: "NT", totalChapters: 22, studiedChapters: [1, 21, 22], tags: ["Profecia"], lastUpdate: "2024-01-20T17:00:00Z" },
];
